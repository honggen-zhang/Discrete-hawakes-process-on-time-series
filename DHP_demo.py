...
saving_model_path = '/home/user1/Desktop/DHP/output_cluster/IP_c3/full_'+str(0)+'.pt'
...
for i in range(len(windows)):
    ...
    if __name__ == '__main__':
        ...
        #hawkes_model.save_model(saving_model_path, mode='entire')
        #hawkes_model.save_model(saving_model_path, mode='parameter')
