...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 16 11:34:07 2021

@author: honggen@hawaii.edu
"""
...
from preprocess.dataset import load_sequences_csv
from preprocess.DataOperation import data_info, EventSampler, enumerate_all_events, samples2dict
import os
from model.DHP import HawkesProcessModel
import pandas as pd
...
file_path = '/home/user1/Desktop/DHP/data/IP/data_label_norm/'
cluster_file = '/home/user1/Desktop/DHP/output_cluster/cluster_file/IP_C3_KG'
loading_model_path = '/home/user1/Desktop/DHP/output_cluster/IP_c3/full_'+str(0)+'.pt'
...
for i in range(len(windows)):
    ...
    if __name__ == '__main__':
        ...
        #hawkes_model.plot_causality_ave(A,output_name='/home/user1/Desktop/ddhp/paper_figures/A/IP_c1'+'.pdf')
